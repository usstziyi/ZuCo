...
import numpy as np
import h5py
import utils_load_data_v2 as dh
from tqdm import tqdm
import pickle
import argparse


def ZuCo_data_v2(data_dir,save_data_dir,verbose=True):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Load EEG data from version 2 of the ZuCo dataset')
    parser.add_argument('--data_dir', type=str, default=loc_data, help='Path to the ZuCo v2.0 data directory.')
    ...
    ZuCo_data_v2(args.data_dir, args.save_data_dir, args.verbose)
